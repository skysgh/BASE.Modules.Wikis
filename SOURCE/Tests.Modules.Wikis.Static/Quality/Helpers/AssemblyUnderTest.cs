...
namespace Tests.Modules.Wikis.Static.Quality.Helpers
{
	/// <summary>
	/// Provides reflection-based access to all Wikis module assemblies
	...
	{
		/// <summary>
		/// All Wikis module production assemblies (non-test).
		/// </summary>
		...
		private static List<Assembly> LoadAll()
		{
			...
			return AppDomain.CurrentDomain.GetAssemblies()
				.Where(a =>
				{
					...
					return name.Contains("App.Modules.Wikis", StringComparison.OrdinalIgnoreCase)
