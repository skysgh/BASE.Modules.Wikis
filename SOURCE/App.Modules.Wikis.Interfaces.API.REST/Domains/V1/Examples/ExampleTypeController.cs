using App.Modules.Wikis.Application.Domains.Examples.Dtos;
using App.Modules.Wikis.Application.Domains.Examples.Services;
...
namespace App.Modules.Wikis.Interfaces.API.REST.Domains.V1.Examples
{
    /// <summary>
    /// REST controller for <see cref="ExampleTypeDto"/> CRUST operations.
