...
namespace App.Modules.Wikis.Application.Domains.Examples.Services
{
    /// <summary>
    ...
    public interface IExampleValueObjectApplicationService
		: ICrudStateAppService<ExampleValueObjectDto, ExampleValueObjectDto, ExampleValueObjectDto>
	{
	}
}
