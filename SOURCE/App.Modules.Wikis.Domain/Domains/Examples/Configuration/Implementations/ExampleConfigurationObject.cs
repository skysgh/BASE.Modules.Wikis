using App.Modules.Wikis.Domain.Domains.Examples.Constants;
...
namespace App.Modules.Wikis.Domain.Domains.Examples.Configuration.Implementations
{
    /// <summary>
    ...
    public class ExampleConfigurationObject : IConfigurationObject
    {
        ...
        [ConfigurationPropertyDescriptionAttribute(
            true,
            false,
            WikisConfigKeys.AreYouTryingToDoGood,
        ...
        [ConfigurationPropertyDescriptionAttribute(
            true,
            false,
            WikisConfigKeys.AnotherExampleServiceImplementation,
            "Another Example Service Implementation",
            "Identifies which nested service configuration implementation should be used.",
            WikisConfigKeys.ImplementationOptions.AnotherExampleA)]
        public string AnotherExampleServiceImplementation { get; set; } = WikisConfigKeys.ImplementationOptions.AnotherExampleA;
