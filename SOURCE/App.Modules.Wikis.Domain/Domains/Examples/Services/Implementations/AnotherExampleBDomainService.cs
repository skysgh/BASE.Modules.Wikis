...
namespace App.Modules.Wikis.Domain.Domains.Examples.Services.Implementations
{
    /// <summary>
    /// Alternate configuration-selected implementation of <see cref="IAnotherExampleDomainService"/>.
    /// </summary>
    [ConditionalService(WikisConfigKeys.Implementation, WikisConfigKeys.ImplementationOptions.AnotherExampleB)]
